...
object MockStudyData {
    ...
    var currentUserProfile by mutableStateOf(
        UserProfile(
            name = "FFMAX",
            phone = "01774077462",
            birthDate = "16 Jan, 2008",
            gender = "ছাত্র",
            avatarUrl = "",
            studentClass = "এইচএসসি",
            group = "বিজ্ঞান",
            examBatch = "এইচএসসি ২০২৭",
            classShift = "প্রযোজ্য নয়",
            sscBoard = "Jessore",
            sscRoll = "762180",
            institutionDivision = "Chattogram",
            institutionDistrict = "Khagrachari",
            institutionName = "GOJAPARA JUNIOR SCHOOL",
            educationMedium = "কোনটাই নয়",
            guardianName = "Julia begum",
            guardianPhone = "01774077462"
        )
    )
}

data class UserProfile(
    val name: String = "FFMAX",
    val phone: String = "01774077462",
    val birthDate: String = "16 Jan, 2008",
    val gender: String = "ছাত্র", // ছাত্র or ছাত্রী
    val avatarUrl: String = "",
    val studentClass: String = "এইচএসসি",
    val group: String = "বিজ্ঞান",
    val examBatch: String = "এইচএসসি ২০২৭",
